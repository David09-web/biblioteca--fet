...
<div class="auth-container" style="align-items: flex-start; padding-top: 3rem;">
    <div class="auth-card" style="max-width: 600px;">
        <div class="auth-header">
            <h1>Editar Libro</h1>
            <p>Modifica los detalles de este ejemplar</p>
        </div>
        ...
        <form method="POST" action="{{ route('books.update', $book) }}">
            ...
            <div class="form-group">
                ...
                <input id="title" type="text" class="form-control" name="title" value="{{ old('title', $book->title) }}" required autofocus>
            ...
            <div class="form-group">
                ...
                <input id="editorial" type="text" class="form-control" name="editorial" value="{{ old('editorial', $book->editorial) }}">
                @error('editorial')<div class="error-message">{{ $message }}</div>@enderror
            </div>

            <div class="form-group">
                <label for="isbn" class="form-label">ISBN</label>
                <input id="isbn" type="text" class="form-control" name="isbn" value="{{ old('isbn', $book->isbn) }}" required>
            ...
            <div style="display: flex; gap: 1rem;">
                <div class="form-group" style="flex: 1;">
                    ...
                    <input id="total_copies" type="number" min="1" class="form-control" name="total_copies" value="{{ old('total_copies', $book->total_copies) }}" required>
                ...
                <div class="form-group" style="flex: 1;">
                    ...
                    <input id="available_copies" type="number" min="0" class="form-control" name="available_copies" value="{{ old('available_copies', $book->available_copies) }}" required>
